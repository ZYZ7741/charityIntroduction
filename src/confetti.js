var confetti = {
  maxCount: 150, // 设置最大数量的五彩纸屑
  speed: 2, // 设置五彩纸屑动画的速度
  frameInterval: 15, // 五彩纸屑动画帧间隔（毫秒）
  alpha: 1.0, // 五彩纸屑的不透明度（0到1之间，其中1是不透明，0是透明）
  gradient: true, // 是否为五彩纸屑使用渐变
  start: null, // 启动五彩纸屑动画的函数（可选的超时时间，以毫秒为单位，和可选的最小和最大随机五彩纸屑数量）
  stop: null, // 停止添加五彩纸屑的函数
  toggle: null, // 启动或停止五彩纸屑动画的函数，取决于它是否已经在运行
  pause: null, // 暂停五彩纸屑动画的函数
  resume: null, // 恢复五彩纸屑动画的函数
  togglePause: null, // 切换五彩纸屑动画是否暂停的函数
  remove: null, // 停止五彩纸屑动画并立即移除所有五彩纸屑的函数
  isPaused: null, // 调用并返回五彩纸屑动画是否暂停的布尔值
  isRunning: null, // 调用并返回动画是否正在运行的布尔值
};
